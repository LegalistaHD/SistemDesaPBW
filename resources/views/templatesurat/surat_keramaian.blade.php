...
<body>
    ...
    <div class="container">
        ...
        <p class="mt-5">Orang tersebut di atas adalah benar-benar warga kami yang bertempat tinggal di [alamat_jalan] RT [rt] RW [rw] Dusun [dusun] [Sebutan_Desa] [nama_des] dan tercatat dengan No. KK : [no_kk] Kepala Keluarga : [kepala_kk].</p>
        <p class="mt-2">Surat Keterangan ini dibuat untuk Keperluan : {{ keperluan }}</p>
