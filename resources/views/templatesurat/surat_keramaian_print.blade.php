    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td>RT {{ $detailSurat->where('field', 'rt')->first()->value }} RW {{ $detailSurat->where('field', 'rw')->first()->value }}Dusun {{ $detailSurat->where('field', 'dusun')->first()->value }} {{ $detailSurat->where('field', 'desa')->first()->value }} Kecamatan {{ $detailSurat->where('field', 'kecamatan')->first()->value }}Kabupaten {{ $detailSurat->where('field', 'kabupaten')->first()->value }}</td>
            </tr>
        </table>
        <p class="mt-5">Orang tersebut di atas adalah benar-benar warga kami yang bertempat tinggal di RT {{ $detailSurat->where('field', 'rt')->first()->value }} RW {{ $detailSurat->where('field', 'rw')->first()->value }}Dusun {{ $detailSurat->where('field', 'dusun')->first()->value }} {{ $detailSurat->where('field', 'desa')->first()->value }}dan tercatat dengan No. KK : {{ $detailSurat->where('field', 'nomorKk')->first()->value }}</p>
        <p class="mt-2">Surat Keterangan ini dibuat untuk Keperluan : {{ $detailSurat->where('field', 'keperluan')->first()->value }} </p>
