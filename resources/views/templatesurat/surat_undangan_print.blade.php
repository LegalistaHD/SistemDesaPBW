        ...
        <div class="tujuan-surat">
            <table>
                <tr>
                    <td>Kepada Yth</td>
                    <td>:</td>
                    <td>{{ $detailSurat->where('field', 'kepadaYth')->first()->value }}</td>
                </tr>
                <tr>
                    <td>Alamat  </td>
                    <td>:</td>
            ...
            <table>
                <tr>
                    <td>Waktu</td>
                    <td>:</td>
                    <td>{{ $detailSurat->where('field', 'waktu')->first()->value }}</td>
                </tr>
                <tr>
                    <td>Tempat</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Acara</td>
                    <td>:</td>
                    <td>{{ $detailSurat->where('field', 'acara')->first()->value }}</td>
                </tr>
            </table>
            ...
            <div class="tanda_tangan text-center">
                ...
                <h4> {{ $detailSurat->where('field', 'namaPengirim')->first()->value }}</h4>
            </div>
        </div>
